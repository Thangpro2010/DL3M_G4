...
<body>
    ...
    <div class="container address-to w3-padding-top-64">
        <a href="index-user.php" class="w3-text-black w3-hover-text-red" style="text-decoration: none;">Trang Chủ</a> ><a href="tour-trung-user.php" class="w3-text-black w3-hover-text-red" style="text-decoration: none;"> Miền Trung</a>
        <hr>
    </div>
            ...
            ?>
                    <div class="w3-col l3 m6 w3-container w3-padding-32">
                        ...
                        <div class="w3-col w3-padding w3-border w3-card">
                            ...
                            <?php echo " <a href='tour-trung-details-user.php?id={$row['tour_id']}'><input class='submit-details w3-medium w3-right' type='submit' value='Xem Chi Tiết'></a>"?>
                        </div>
                    </div>
            <?php
                }
