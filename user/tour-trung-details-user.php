...
if (isset($_POST["booking"])) {
    header("location: booking-trung.php?id={$persons["tour_id"]}");
}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-col l6 w3-padding" style="font-size: 1.66rem; margin-top: 1.2rem;">
                            ...
                            <form action="" method="POST">
                                ...
                                <a href="<?php ?>"><input type="submit" value="Đặt Tour" name="booking" id="booking" class="btn btn-primary" style="float: right; font-size: 1.5rem;"></a>
                            </form>
                            <br><br>
                        </div>
                    </div>
