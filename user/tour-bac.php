...
<body>
    ...
    <br><br>
        <div class="container address-to w3-padding-top-64">
            <a href="index.php" class="w3-text-black w3-hover-text-red" style="text-decoration: none;">Trang Chủ</a> ><a href="tour-bac.php" class="w3-text-black w3-hover-text-red" style="text-decoration: none;"> Miền Bắc</a>
            <hr>
        </div>
        <!--Tour-->
                ...
                ?>
                        <div class="w3-col l3 m6 w3-container w3-padding-32">
                            ...
                            <div class="w3-col w3-padding w3-border w3-card">
                                ...
                                <i class="fa fa-map-marker w3-medium" aria-hidden="true"> Nơi Khởi Hành: <span><?php echo $row["region"] ?></span></i><br><br>
                                <?php echo " <a href='tour-bac-details.php?id={$row['tour_id']}'><input class='submit-details w3-medium w3-right' type='submit' value='Xem Chi Tiết'></a>"?>
                            </div>
                        </div>
                <?php
                    }
