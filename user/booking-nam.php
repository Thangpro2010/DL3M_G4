...
if (isset($_POST["btOK"])) {
    ...
    if ($amount > $soluong) {
        echo "<script type='text/javascript'>
                ...
                window.location = 'booking-nam.php?id={$persons['tour_id']}';
            </script>";
    } else {
    }
    ...
    echo "<script type='text/javascript'>
            ...
            window.location = 'tour-nam-user.php';
        </script>";
    // var_dump($create);
    // exit();
}
...
<body>
    ...
    <div class="container">
        <form action="" method="POST">
            <p style="font-weight: 600; font-size: 2rem;" class="w3-text-red">THÔNG TIN HÓA ĐƠN</p>
            <div class="w3-medium">
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="w3-medium w3-padding-16 w3-text-red">
                                    <span style="font-size: 1.8rem;">Tổng Tiền: </span><input style="border: none; outline: none; font-size: 1.8rem;" w3-large" type="number" name="tongtien" id="tongtien" readonly value="<?php echo $persons['price'] ?>">
                                </div>
                            </td>
                        </tr>
                    </tbody>
