            ...
            <div class="container-fluid">
                <div class="container w3-padding" style="background-color: #f5f6fa;">
                    <div class="w3-row w3-padding-16">
                        ...
                        <a href="<?php echo "event-details-user.php?id={$sv['event_id']}" ?>"><input class="submit-details w3-xsmall w3-right" type="submit" value="Xem Chi Tiết"></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <nav aria-label="Page navigation example" style="float: right;">
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $pages; $i++) {
                    ?>
                        <li class="page-item"><a class="page-link" href="event-user.php?pages=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php
                    }
                    ?>
                </ul>
