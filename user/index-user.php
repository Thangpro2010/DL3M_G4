            ...
            <div class="w3-row-padding w3-center">
                <div class="w3-col l4 w3-margin-bottom w3-padding-16">
                    ...
                    <div class="w3-padding-16">
                        <a href="tour-bac-user.php" class="w3-center w3-large" style="font-weight: 600; text-decoration: none;">Khám Phá Ngay <i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
                    </div>
                </div>
                <div class="w3-col l4 w3-margin-bottom w3-padding-16">
                    <div class="w3-display-container">
                    ...
                    <div class="w3-padding-16">
                        <a href="tour-trung-user.php" class="w3-center w3-large" style="font-weight: 600; text-decoration: none;">Khám Phá Ngay <i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
                    </div>
                </div>
                <div class="w3-col l4 w3-margin-bottom w3-padding-16">
                    <div class="w3-display-container">
                    ...
                    <div class="w3-padding-16">
                        <a href="tour-nam-user.php" class="w3-center w3-large" style="font-weight: 600; text-decoration: none;">Khám Phá Ngay <i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="w3-container">
                    <div class="w3-col l6 w3-center">
                        <!--video travel-->
                        <video class="w3-center w3-padding" width="100%" height="auto" src="video/VideoTravelAroundVietNam2.mp4" autoplay muted></video>
                    </div><br><br>
