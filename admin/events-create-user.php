    ...
    if ((isset($_POST["submit"])) && (checkfile($_FILES["file"]["name"]))) {
        ...
        if ((isset($_FILES["file"])) && (!$_FILES["file"]["error"])) {
            if (move_uploaded_file($file, "../admin/uploads/" . $path)) {
                $e = new event($event_id, $topic, $path, $content, $details, $date);
                event::createEvent($e);
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h6 style="font-weight: 800; font-size: 1.2rem; color: tomato;"><i class="fas fa-plus-square" style="font-weight: 500;"></i> THÊM THÔNG TIN</h6><br>
            <form action="" method="POST" enctype="multipart/form-data" style="font-size: 14px;">
                ...
                <div class="form-group">
                    <input type="submit" value="Thêm Sự Kiện" class="btn btn-info" name="submit" style="font-size: 16px; float: right;">
                </div>
                <br>
            </form>
        </div>
