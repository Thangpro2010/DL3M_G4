                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($ds as $row) {
                            ...
                            echo "<td>";
                            echo "<a href='feedback-view-user.php?id={$row['feedback_id']}'><button type='delete' class='btn btn-danger' onclick='return confirm(\"Bạn Có Chắc Muốn Xóa Đánh Giá Này ?\")' style='font-size:12px;'><i class='fas fa-trash-alt'></i></button></a>";
                            echo "</td>";
                            echo "<tr>";
                            // echo "<td>";
