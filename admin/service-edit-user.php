    ...
    if ((isset($_POST["submit"])) && (checkfile($_FILES["file"]["name"]))) {
        ...
        if ((isset($_FILES["file"])) && (!$_FILES["file"]["error"])) {
            if (move_uploaded_file($file, "../admin/uploads/" . $path)) {
                editService($service_id, $topic, $path, $address);
...
if (isset($_GET["id"]) == false) {
    header("location: service-view-user.php");
    exit();
}
$id = $_GET["id"];
$ds = getListServiceByID($id);
?>
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h6 style="font-weight: 800; font-size: 1.2rem; color: tomato;"><i class="fas fa-edit" style="font-weight: 500;"></i> CẬP NHẬT DỊCH VỤ</h6><br>
            <form action="" method="POST" enctype="multipart/form-data" style="font-size: 14px;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""><b>ID:</b></label>
                            <input class="form-control" type="text" name="id" id="id" readonly value="<?php echo $ds['service_id'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="address" id="address" required value="<?php echo $ds['address'] ?>">
                </div><br>
                <div class="form-group">
                    <span>Ảnh Trước: </span><br>
                    <?php echo "<img src='uploads/{$ds['path']}' alt='' width=300px;> <br><br>" ?>
